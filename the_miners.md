...
#### OLD FRENCH
The current location of French Henry camp is the location of the mill built to process ore from the French Henry mine to the northwest. The path of the ore cart can be clearly seen in Google Maps. Older Philmont maps show a road going from Copper Park to Old French. If it was a road at some point it is not one any longer.
